        ...
        <Container className="contactInformation_ContactUsPage d-flex justify-content-center align-items-center shadow-lg px-0  py-5 ">
            <Row className=" w-100 " >
                ...
                <Col md={6} className=" h-100  px-0">
                    <div className="contactInformationContainer pt-5 ps-5 " >
                        ...
                        <p style={{ top: "5vw" }} className="phone_number text-white mb-4  position-relative ">
                            <img className=" me-4 " style={{ width: "1.6666666666666667vw", height: "1.6666666666666667vw" }} src="../../../public/assets/Images/bxs_phone-call.png" alt="" />
                            <span>
                        ...
                        <p style={{ top: "5vw" }} className="phone_number mb-4 text-white position-relative   ">
                            <img className=" me-4 " style={{ width: "1.6666666666666667vw", height: "1.6666666666666667vw" }} src="../../../public/assets/Images/ic_sharp-email.png" alt="" />
                            <span>
                        ...
                        <p style={{ top: "5vw" }} className="phone_number text-white d-flex justify-content-start  align-items-center  position-relative  ">
                            <img className=" me-4 " style={{ width: "1.6666666666666667vw", height: "1.6666666666666667vw" }} src="../../../public/assets/Images/carbon_location-filled.png" alt="" />
                            <span className=" w-50">
                                D.NO.24-6-707/1 military colony, opp: Lic office, kondayapaleam gate, Nellore 524003
                            </span>
                        </p>

                        <img className="floatingImageOne_ContactUsPage" src="../../../public/assets/Images/Ellipse 793.png" alt="" />
                        <img className="floatingImageTwo_ContactUsPage" src="../../../public/assets/Images/Ellipse 794.png" alt="" />
                ...
                <Col md={6} className=" px-0 ">
                    <img className="googleMapImage img-fluid " src="../../../public/assets/Images/Component 6.png" alt="" />
                </Col>
