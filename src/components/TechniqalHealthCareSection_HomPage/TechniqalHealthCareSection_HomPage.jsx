...
const TechniqalHealthCareSection_HomPage = () => {
    return (
        <Container fluid className="techniqalHealthCareSection_HomPage px-0 ">
            <img src="../../../public/assets/Images/Group 1171282611.png" alt="" />
            ...
            <Container fluid className="d-flex justify-content-between  align-items-center w-75  px-0 " style={{ marginTop: "9.208333333333333" }}>
                <TechniqalHealthCareCard_HomePage
                    cardImg="../../../public/assets/Images/Group 1171282609 (3).png"
                ...
                <TechniqalHealthCareCard_HomePage
                    cardImg="../../../public/assets/Images/Group 1171282609 (4).png"
                ...
                <TechniqalHealthCareCard_HomePage
                    cardImg="../../../public/assets/Images/Group 1171282609 (5).png"
